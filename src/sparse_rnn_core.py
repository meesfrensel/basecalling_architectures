            ...
            for name, tensor in module.named_parameters():
                ...
                if name in self.name2variance:
                    val = '{0}: {1}->{2}, density: {3:.3f}, proportion: {4:.4f}'.format(
                        ...
                        num_nonzeros/float(mask.numel()), self.name2variance[name])
                    print(val)
                    if 'rnn' in name:
                        ...
                        for i in range(len(num_newmasks_print)):
                            print('{0}: {1}->{2}, density: {3:.3f}, proportion: {4:.4f}'.format(
                                gate_name[i], int(self.gates_nonzeros[name][i]), num_newmasks_print[i], 
